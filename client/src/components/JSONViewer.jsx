...
const JSONValue = ({ value, path = "", onHover, onHoverEnd }) => {
  ...
  const renderValue = (val, currentPath) => {
    ...
    if (
      ...
      // Handle binary file objects wrapped with provenance
      if (actualValue && typeof actualValue === "object" && actualValue._type === "file" && actualValue._link) {
        const metadata = actualValue._metadata || {};
        return (
          <div
            className="inline-flex items-center space-x-2 bg-blue-50 border border-blue-200 rounded-lg px-3 py-2 cursor-help hover:bg-yellow-100"
            onMouseEnter={(e) => handleMouseEnter(e, currentPath, source)}
            onMouseLeave={handleMouseLeave}
          >
            <div className="flex items-center space-x-2">
              ...
              <a
                ...
                onClick={(e) => e.stopPropagation()} // Prevent triggering provenance hover
              >
