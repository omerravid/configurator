...
const ScalarPropertiesPanel = ({
  ...
  console.log("ScalarPropertiesPanel Debug:", {
    ...
    componentRef,
    actualValue: selectedValue ? getActualValueAndSource(selectedValue).actualValue : null,
    availableVersions: availableVersions.length
  });

  // Load available versions when a component is selected
  useEffect(() => {
    console.log("Loading versions effect triggered:", { componentRef, componentId: componentRef?.componentId });
      ...
      configAPI.getComponents()
        .then(response => {
          ...
          if (component) {
            ...
            console.log("Set available versions:", component.versions || []);
          }
        })
        .catch(error => {
  ...
  const handleVersionChange = (newVersionId) => {
    console.log("Version change triggered:", {
      newVersionId,
      componentRef,
      configType,
      isEditable,
    ...
    console.log("Updating component ref:", { old: componentRef, new: updatedComponentRef });
