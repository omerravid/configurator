...
const BulkOperations = ({
  ...
  const handleOperationClick = (operation) => {
    // Check both 'requiresConfirmation' and 'confirm' for backward compatibility
    const needsConfirmation = operation.requiresConfirmation ?? operation.confirm ?? true;
  ...
  return (
    <div className="space-y-4">
      {/* Selection Header - Restructured for better UX */}
      <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
          ...
          {selectedCount > 0 && (
            <div className="flex items-center gap-2">
              ...
              <span className="px-2.5 py-1 text-xs font-bold rounded-full bg-primary-600 text-white">
                {selectedCount}
              </span>
            </div>
          )}
        ...
        {/* Row 2: Bulk Action Buttons (shown when items selected) */}
        ...
        {/* Progress Indicator (replaces action buttons when processing) */}
        {isProcessing && (
          <div className="px-4 py-3 bg-white dark:bg-gray-800">
          ...
          return (
            <div
              ...
              className={`
                ...
                ${isSelected
                  ? 'bg-primary-50 dark:bg-primary-900/30 border-primary-400 dark:border-primary-600 ring-2 ring-primary-200 dark:ring-primary-800'
            ...
            >
              <input
                ...
                className="w-4 h-4 rounded border-gray-300 text-primary-600 focus:ring-primary-500 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
              />
              {renderItem ? (
      ...
      {showConfirm && pendingOperation && (
        <ConfirmDialog
          ...
          message={
            typeof pendingOperation.confirmMessage === 'function'
              ? pendingOperation.confirmMessage(selectedCount)
